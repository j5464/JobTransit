...
def create_silver_tables():
    ...
    ddl = [
        ...
        CREATE TABLE IF NOT EXISTS company (
            ...
            url_status VARCHAR(10) NULL DEFAULT NULL COMMENT '職缺頁面狀態: on, off 或 NULL',
            INDEX idx_company_industry_no (industry_no),
            INDEX idx_company_url_status (url_status)
        ...
        CREATE TABLE IF NOT EXISTS job (
            ...
            url_status VARCHAR(10) NULL DEFAULT 'on' COMMENT '職缺頁面狀態: on, off 或 NULL',
            INDEX idx_job_appear_date (appear_date),
            INDEX idx_job_url_status (url_status),
            INDEX idx_job_location (address_region, address_area),
...
if __name__ == "__main__":
    ...
    print("silver tables initialized")
